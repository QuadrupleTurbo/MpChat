    ...
    internal static class Logger
    {
        ...
        internal static void Log(this string msg, bool notify = false)
        {
            ...
            if (notify)
            {
                ...
                API.SetNotificationMessage("CHAR_BLANK_ENTRY", "CHAR_BLANK_ENTRY", true, 4, "MpChat", "Success");
        ...
        internal static void Alert(this string msg, bool notify = false)
        {
            ...
            if (notify)
            {
                ...
                API.SetNotificationMessage("CHAR_BLANK_ENTRY", "CHAR_BLANK_ENTRY", true, 4, "MpChat", "Alert");
        ...
        internal static void Warning(this string msg, bool notify = false)
        {
            ...
            if (notify)
            {
                ...
                API.SetNotificationMessage("CHAR_BLANK_ENTRY", "CHAR_BLANK_ENTRY", true, 4, "MpChat", "Warning");
                API.DrawNotification(true, false);
            }
        }
        ...
        internal static void Error(this string msg, bool notify = false)
        {
            ...
            if (notify)
            {
                ...
                API.SetNotificationMessage("CHAR_BLANK_ENTRY", "CHAR_BLANK_ENTRY", true, 4, "MpChat", "Error");
                API.DrawNotification(true, false);
            }
        }
